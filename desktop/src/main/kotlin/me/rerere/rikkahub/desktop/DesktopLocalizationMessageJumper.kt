...
internal val DesktopMessageJumperTranslations = mapOf(
    DesktopLanguage.CHINESE_TRADITIONAL to mapOf(
        "jumper.search_messages" to "搜尋訊息", "jumper.no_matching_messages" to "沒有符合的訊息",
    ...
    DesktopLanguage.KOREAN to mapOf(
        ...
        "jumper.user" to "나", "jumper.assistant" to "어시스턴트", "jumper.empty_message" to "메시지 내용 없음"
    ),
    DesktopLanguage.RUSSIAN to mapOf(
        "jumper.search_messages" to "Поиск сообщений", "jumper.no_matching_messages" to "Нет совпадающих сообщений",
        "jumper.user" to "Вы", "jumper.assistant" to "Ассистент", "jumper.empty_message" to "Нет текста сообщения"
    ),
    DesktopLanguage.SPANISH to mapOf(
        "jumper.search_messages" to "Buscar mensajes", "jumper.no_matching_messages" to "No hay mensajes coincidentes",
